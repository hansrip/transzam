CREATE TABLE user (id BIGINT AUTO_INCREMENT, name VARCHAR(255), login VARCHAR(255), password VARCHAR(255), mobile_number BIGINT, token VARCHAR(255), user_type VARCHAR(255), number_of_trucks BIGINT, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE user (id BIGINT AUTO_INCREMENT, name VARCHAR(255), login VARCHAR(255), password VARCHAR(255), mobile_number BIGINT, token VARCHAR(255), user_type VARCHAR(255), number_of_trucks BIGINT, INDEX user_user_type_idx (user_type), PRIMARY KEY(id)) ENGINE = INNODB;
